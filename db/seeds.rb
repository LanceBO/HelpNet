...
training5 = Training.create(title: "Quelles sont les alternatives à Gmail", category: "email", description: "Gmail ne convient pas ? Grâce à cette formation vous aurez une liste exhaustive des outils similaires à Gmail", price: 30, image: "gmail-alternatives.jpg")
