...
solution = Solution.create(videourl: "https://www.youtube.com/embed/vhxLsok_9MM", title: "How to attach file to an email", description: "To attach a file to an email, bla bla bla", problems: "Ma pièce jointe jointe ne s'envoie pas")
solution2 = Solution.create(videourl: "https://www.youtube.com/embed/vhxLsok_9MM", title: "Blablabla", description: "blablabla", problems: "Je n'arrive pas à mettre jointe dans mon e-mail")
