...
training4 = Training.create(title: "Après Gmail, je débute avec Google Workspace", category: "email", description: "Découvrez les outils liés à votre comtpe Gmail grâce à la plateforme Google Workspace", price: 40, image: "google-workspace.jpg")
